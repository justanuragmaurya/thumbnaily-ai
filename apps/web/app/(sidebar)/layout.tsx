...
return(
  <div className="h-screen flex flex-col items-center justify-center">
    ...
    <Button onClick={()=>{signIn("google")}}><Image src={"https://cdn.iconscout.com/icon/free/png-256/free-google-logo-icon-download-in-svg-png-gif-file-formats--brands-pack-logos-icons-189824.png?f=webp&w=256"} height={15} width={15} alt="logo"/>Sign in with Google</Button>
  </div>
)
}